                            ...
                            <div className="container">
                                ...
                                <div className="row">
                                    <div className="row" id="portfolio-grid">
                                        <div className="item col-md-3 col-sm-6 col-xs-12 furniture">
                                            <figure>
                                        ...
                                        <div className="item col-md-3 col-sm-6 col-xs-12 wallpaper">
                                            <figure>
                                        ...
                                        <div className="item col-md-3 col-sm-6 col-xs-12 nature">
                                            <figure>
                                        ...
                                        <div className="item col-md-3 col-sm-6 col-xs-12 branding">
                                            <figure>
                                        ...
                                        <div className="item col-md-3 col-sm-6 col-xs-12 wallpaper furniture">
                                            <figure>
                                        ...
                                        <div className="item col-md-3 col-sm-6 col-xs-12 branding nature">
                                            <figure>
                                        ...
                                        <div className="item col-md-3 col-sm-6 col-xs-12 nature wallpaper">
                                            <figure>
